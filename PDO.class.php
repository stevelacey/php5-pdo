 ...
 * ____________________________________ */
    ...
    class _PDO {
        ...
        function __construct($string_dsn, $string_username = '', $string_password = '', $array_driver_options = null) {
          ...
          // Hack to allow for mysql-alternative-pdo dbtype
          $con['dbtype'] = strpos($con['dbtype'], '-') !== false ? substr($con['dbtype'], 0, strpos($con['dbtype'], '-')) : $con['dbtype'];
      ...
      public static function getAvailableDrivers() {
        return array('mysql-alternative-pdo');
      }
    }
